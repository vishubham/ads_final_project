...
The main objective of this project is to provide a stock market data analysis tool that can be used by retail investors to identify long term investment opportunities in stocks traded on the New York Stock Exchange (NYSE). Once we establish a working model that works for long term investors, the tool can be further developed to add enhanced capabilities to handle instantaneous data analysis for use in day trades.
""")
